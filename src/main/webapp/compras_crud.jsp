                                ...
                                <div
                                    ...
                                    <div class="form-floating mb-3 position-relative">
                                        <input type="text"
                                               ...
                                               maxlength="12"
                                               pattern="^\d{3,12}$"
                                               title="Debe contener entre 3 y 12 dígitos numéricos.">
                                        <label for="numero_de_orden">Número de compra</label>
                                        ...
                                        <div class="invalid-feedback" id="error_formato" style="display: none;">
                                            Se requieren entre 3 y 12 dígitos numéricos. No se permiten letras ni símbolos.
                                        </div>
                                    </div>

                                    <!-- Fecha de compra -->
                                    <label for="fecha_de_orden">Fecha De Compra <span class="text-danger">*</span></label>
                                    <div class="form-floating mb-3">
                                        <input type="date"
                                               ...
                                               required
                                               readonly />
                                        <label for="fecha_de_orden">Fecha de compra</label>
                                    ...
                                    <script>
                                        ...
                                        const fechaLocal = new Date(hoy.getTime() - hoy.getTimezoneOffset() * 60000)
                                                .toISOString()
                                                .split('T')[0];
                                        document.getElementById("fecha_de_orden").value = fechaLocal;
                                    </script>
                                    <div class="form-floating mb-3">
                        ...
                        <form name="formulario_editar" id="formulario_editar">
                            <div class="modal-body" style="background: #eeeeef">
                                ...
                                <div class="form-floating mb-3 position-relative">
                                    ...
                                    <div class="invalid-feedback">
                                        Ingrese entre 3 y 12 dígitos numéricos. No se permiten letras ni símbolos.
                                    </div>
                                </div>
